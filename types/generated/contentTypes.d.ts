...
export interface ApiBestSaleBestSale extends Schema.CollectionType {
  collectionName: 'best_sales';
  info: {
    singularName: 'best-sale';
    pluralName: 'best-sales';
    displayName: 'best_sale';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<
      ...
      'api::category.category'
    >;
    product_states: Attribute.Relation<
      'api::product.product',
      'manyToMany',
      'api::product-state.product-state'
    >;
...
export interface ApiProductStateProductState extends Schema.CollectionType {
  collectionName: 'product_states';
  info: {
    singularName: 'product-state';
    pluralName: 'product-states';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::best-sale.best-sale': ApiBestSaleBestSale;
      'api::category.category': ApiCategoryCategory;
      'api::order.order': ApiOrderOrder;
      'api::product.product': ApiProductProduct;
      'api::product-state.product-state': ApiProductStateProductState;
